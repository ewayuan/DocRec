...
class cnnBlock(nn.Module):
    def __init__(self):
        ...
        self.affine_query_profile = nn.Linear(in_features=14884, out_features=2000)
        self.relu = nn.ReLU()
        ...
        self.affine_query_dialogs = nn.Linear(in_features=11468, out_features=2000)
        
        self.bn1 = nn.BatchNorm1d(num_features=768)
        self.fc1 = nn.Linear(4000, 768)
    ...
    def cnn_query_dialogs(self, matrix):
        print("cnn_query_dialogs matrix: ", matrix)
        matrix = matrix.unsqueeze(1)
